"""
不依赖 rdagent 模块统计演进因子数量（Windows 兼容版本）
"""
import pickle
import os
import json
...
print(f"文件大小: {os.path.getsize(latest_session) / 1024 / 1024:.2f} MB")
...
result_file = os.path.join(log_folder, "factor_count_result.json")
