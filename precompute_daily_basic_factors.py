...
def main():
    ...
    - Output H5:  F:/Dev/AIstock/factors/daily_basic_factors/result.h5
    ...
    # 输出根目录：在 Windows 下直接写入 <Drive>:/，在 WSL/Linux 下映射到 /mnt/<drive>/
    output_root_str = r"F:/Dev/AIstock/factors/daily_basic_factors"
